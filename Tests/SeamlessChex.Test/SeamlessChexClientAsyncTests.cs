namespace SeamlessChex.Test
{
    ...
    public class SeamlessChexClientAsyncTests
    {
        ...
        public async Task CreateAndGetCheckTestAsync(CreateCheckRequest createCheckRequest, UpdateCheckRequest updateCheckRequest)
        {
            var check = await this.client.CreateCheckAsync(createCheckRequest).ConfigureAwait(false);
            ...
            check = await this.client.GetCheckAsync(checkId).ConfigureAwait(false);
            ...
            check = await this.client.UpdateCheckAsync(updateCheckRequest).ConfigureAwait(false);
            ...
            var collection = await this.client.GetChecksAsync(parameters).ConfigureAwait(false);
            ...
            var voided = await this.client.VoidCheckAsync(checkId).ConfigureAwait(false);
